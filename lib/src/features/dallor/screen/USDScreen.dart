...
//   const USDSCreen({Key key}) : super(key: key);
...
//                           //color: csblack,
//                           child: Text(
//                            AppLocalizations.of(context)!.translate("accNum")! +": 0887112932",
//                             style: TextStyle(
//                               fontSize: 15,
//                               color: Colors.blue,
//                             ),
...
//                           //color: mainColor,
//                           child: Text(
//                             "1,100 "+AppLocalizations.of(context)!.translate("usd")!,
//                             style: TextStyle(
//                                 fontSize: 30,
//                                 color: csblack,
...
//                         style: TextStyle(
//                             fontWeight: FontWeight.bold, fontSize: 17,fontFamily: 'kh'),
//                       ),
//                     ),
//                   ),
//                   Expanded(
...
//                       height: 20,
//                       //color: mainColor,
//                       child: Text(AppLocalizations.of(context)!.translate("see more")!,style: TextStyle(fontFamily: 'kh'),),
//                     ),
//                   )
//                 ],
//               ),
...
//                           height: 60,
//                           child: Text(
//                             "-2.00 "+ AppLocalizations.of(context)!.translate("usd")!,
//                             style: TextStyle(
//                                 fontSize: 16,
//                                 fontWeight: FontWeight.bold,
//                                 color: Colors.red,fontFamily: 'kh'),

...
class NewRecieptM extends StatefulWidget {
  final String sender;
  final String rec;
  final String amount;
  final String code;
  ...
  @override
  State<NewRecieptM> createState() => _NewRecieptMState();
}

class _NewRecieptMState extends State<NewRecieptM> {
  int s = 0;
...
<html>
    ...
    <html>
     ...
     html{
      ...
      <div id ="body">
        <p id = "title">Counter 1</p>
       <hr></hr>
       <div id = "text">
        <p >Invoice No : ANK122372</p>
        <p >Date : $date</p>
        <p id = "code">Code : ${widget.code}</p>
         <p >Money : ${widget.amount} ${widget.symbol}</p>
        <p >Sender number : ${widget.sender}</p>
        <p >Recipient number : ${widget.rec}</p>
        </div>
        <hr></hr>
         <div id = "noteTitle">
        <p >Expires on $date</p>
